...
class Articulo_model extends CI_Model {
    ...
    public function get_medidas($id){
        $result = $this->db->query("SELECT  a.selected,a.id,a.numero,a.id_articulo,a.nombre nombre_medida,a.precio_nacional,a.precio_acapulco,a.precio_cc,a.precio_tijuana,a.precio_pl,a.cantidad_x_porcion_medida,a.precio_aeropuerto,a.precio_tezontle,a.activo 
        FROM `Articulo_Medida` a where a.id_articulo = ".$id);
        return $result->result();
    }
	public function get_medidas_idioma($id,$id_idioma){
		$registrosI = $this->db->query("SELECT  a.selected,a.id,a.numero,a.id_articulo,a.nombre nombre_medida,a.precio_nacional,a.precio_acapulco,a.precio_cc,a.precio_tijuana,a.precio_pl,a.cantidad_x_porcion_medida,a.precio_aeropuerto,a.precio_tezontle,a.activo 
		...
		if ($existe == 0)
		{
			...
			,a.cantidad_x_porcion_medida,a.precio_aeropuerto,a.precio_tezontle,a.activo 
			FROM `Articulo_Medida_Idioma` a where a.id_articulo = ".$id. ' and a.id_idioma='.$id_idioma." 
			union all 
			SELECT  a.selected,a.id,a.numero,a.id_articulo,a.nombre nombre_medida
			,a.precio_nacional,a.precio_acapulco,a.precio_cc,a.precio_tijuana,a.precio_pl
 ...
 public function articulo_subcategorias2($id_subcategoria,$id_sucursal){
	...
	public function articulo_subcategorias2_idioma($id_subcategoria,$id_sucursal,$id_idioma){
		...
		$result = $this->db->query("select * from (select a.cantidad_x_porcion,aa.orden
			...
			,CONCAT('/menudigital/Articulos/'".",(IF( a.imagen_min<>'',  a.imagen_min,  aa.imagen_min)))  ubicacion_articulo_min
