...
class Login extends CI_Controller {
	...
	/**
	 * Validación de credenciales desde aplicación externa
	 */
// 	function validar_datos_cliente() 
// 	{ 
// 		$this->load->model('Login_model');
// 		$arrayRespuesta = array();
// 		$clientUser = $_POST['client_user'];
// 		$clientPass = sha1($_POST['client_pass']);
// 		$validateUser = $this->Login_model->validar_cliente($clientUser,$clientPass);
// 		if(count($validateUser)>0){
// 			//generar token
// 			$token = "";
// 			$token = bin2hex(random_bytes(64));
// 			$this->Login_model->new_client_session($validateUser[0]->id,$token);
// 			$arrayRespuesta["status"] = "OK";
// 			$arrayRespuesta["respuesta"] = "Usuario correcto";
// 			$arrayRespuesta["token"] = $token;
