...
class Sucursal_model extends CI_Model {
	...
	// {
	// 	// Regla de negocio: Solo se mostrarán las sucursales mas cercanas con un radio de 3km
	...
	// 		-- 6371 indica que el calculo será en KM
	// 	                        ( 6371 * ACOS( 
    //                              COS( RADIANS($latitud) ) 
    //                              * COS(RADIANS( latitud ) ) 
    //                              * COS(RADIANS( longitud ) 
	...
	// 				-- Limitamos la respuesta a 3 sucursales como máximo
